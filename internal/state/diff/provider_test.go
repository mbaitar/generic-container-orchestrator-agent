...
func (t *TestProvider) CreateApplication(ctx context.Context, app *resource.Application) error {
	t.createCalls = append(t.createCalls, *app)
	return t.createErr
}

func (t *TestProvider) UpdateApplication(ctx context.Context, app *resource.Application) error {
	t.updateCalls = append(t.updateCalls, *app)
	return t.updateErr
}

func (t *TestProvider) RemoveApplication(ctx context.Context, app *resource.Application) error {
	t.removeCalls = append(t.removeCalls, *app)
	return t.removeErr
}

func (t *TestProvider) CreateFeature(ctx context.Context, feat feature.Feature) error {
	t.createFeatCalls = append(t.createFeatCalls, feat)
	return t.createFeatErr
}

func (t *TestProvider) UpdateFeature(ctx context.Context, feat feature.Feature) error {
	t.updateFeatCalls = append(t.updateFeatCalls, feat)
	return t.updateFeatErr
}

func (t *TestProvider) RemoveFeature(ctx context.Context, feat feature.Feature) error {
	t.removeFeatCalls = append(t.removeFeatCalls, feat)
	return t.removeFeatErr
}

func (t *TestProvider) ActualState(ctx context.Context) (*state.Spec, error) {
	t.actualCalls += 1
